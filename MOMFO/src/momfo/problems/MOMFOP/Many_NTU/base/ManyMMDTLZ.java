...
public class ManyMMDTLZ extends Problem {
	Integer alpha_;
	...
	public ManyMMDTLZ(String function,int numberOfObjectives, int numberOfVariables, int alpha, double lg, double ug) {
	...
	public ManyMMDTLZ(String function,int numberOfObjectives, int numberOfVariables, int alpha, double lg, double ug, String gType,
