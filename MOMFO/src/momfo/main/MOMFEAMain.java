...
import momfo.metaheuristics.MOMFEA.MOMFEA;
...
public class MOMFEAMain extends AlgorithmMain{

	public MOMFEAMain(Setting test) {
		super(test);
	}
...
//		int OBJ = setting_.getAsInt("Objectives");
		...
		//	continue;
		//}
		algorithm = new MOMFEA(problemSet_);
		...
		DirectoryName = "result/MOMFEA/" + Problemname+"/Task"+String.valueOf(t+1)+"/"+dddname;
