...
import momfo.metaheuristics.parallelsmsemoa.ParallelSMSEMOA;
...
public class ParallelSMSEMOAMain extends AlgorithmMain{

	public ParallelSMSEMOAMain(Setting test) {
		super(test);
	}
...
//		assert false: "test";
		...
		for (int t=0;t < problemSet_.countProblem();t++){
			...
			DirectoryName = "result/ParallelSMSEMOA/" + Problemname+"/"+dddname + "/ref" + setting_.getAsStr("ref");
