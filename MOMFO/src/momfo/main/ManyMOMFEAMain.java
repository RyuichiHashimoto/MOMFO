...
import momfo.metaheuristics.MOMFEA.Many_MOMFEA;
...
public class ManyMOMFEAMain extends AlgorithmMain{

	public ManyMOMFEAMain(Setting test) {
		super(test);
	}
...
//		int OBJ = se        tting_.getAsInt("Objectives");
		...
		//	continue;
		//}
		algorithm = new Many_MOMFEA(problemSet_);
		...
		DirectoryName = "result/ManyMOMFEA/" + Problemname+"/Task"+String.valueOf(t+1)+"/"+dddname;
