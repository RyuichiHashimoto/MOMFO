...
import momfo.metaheuristics.NSGAII_CDP.NSGAII_CDP;
...
public class NSGAIICDPMain extends AlgorithmMain{

	public NSGAIICDPMain(Setting test) {
		super(test);
	}
...
//		int OBJ = setting_.getAsInt("Objectives");
		...
		for (int t=0;t < problemSet_.countProblem();t++){
			...
			algorithm = new NSGAII_CDP(problemSet_.get(t));
			...
			DirectoryName = "result/NSGAIICDP/" + Problemname+"/Task"+String.valueOf(t+1)+"/"+dddname;
