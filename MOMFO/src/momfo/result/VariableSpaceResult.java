...
public class VariableSpaceResult extends GAResult {
	...
	public void afterTrial() throws IOException, NameNotFoundException, NamingException {
		...
		writer.write(solver.getPopulation().variableToStr());
		writer.flush();
	}
	...
	protected String getOutputFinName() throws NamingException {
		return "FinalVAR"+"/" + "FinalVAR"+ (offSet + nOfTrial)+".dat";
	}

	protected String getOutputIniName() throws NamingException {
		return "InitialVAR"+"/" + "InitialVAR"+ (offSet + nOfTrial)+".dat";
	}
