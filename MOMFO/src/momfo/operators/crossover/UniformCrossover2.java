 ...
 * solutions.
 */
public class UniformCrossover2 extends Crossover {
	/**
	 ...
	 */
	public UniformCrossover2(HashMap<String, Object> parameters) {
		super(parameters);
		name = "UniformCrossover2";
	...
	public Object execute(Object object) throws JMException {
		...
		if (parents.length != 2) {
			Configuration.logger_.severe("UniformCrossover22.execute: operator needs two " + "parents");
